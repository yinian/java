...
/**
 * rpc proxy
 * @author yinian 2015-10-29 20:18:32
 * @Description: 工厂Bean，由框架去管理
 */
		...
		return Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(),
				...
				new InvocationHandler() {
					...
					public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
						...
						// client pool [tips03: may save 35ms/100 invoke if move it to constructor,
						// but it is necessary. cause by ConcurrentHashMap.get]
						GenericObjectPool<NettyClientPoolProxy> clientPool =
								NettyClientPool.getPool(zookeeper_switch,serverAddress, request.getClassName(),serializer);
						// client proxy
