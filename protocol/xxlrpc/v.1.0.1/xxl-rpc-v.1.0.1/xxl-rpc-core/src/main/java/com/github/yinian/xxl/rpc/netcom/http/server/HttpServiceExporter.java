package com.github.yinian.xxl.rpc.netcom.http.server;
...
import com.github.yinian.xxl.rpc.netcom.http.codec.HttpRequestInfo;
import com.github.yinian.xxl.rpc.netcom.http.codec.HttpResponseInfo;
import com.github.yinian.xxl.rpc.serialize.Serializer;
import com.github.yinian.xxl.rpc.util.HttpClientUtil;
 ...
 * @author yinian 2015-9-29 14:35:21
 * 
 * 	<servlet>
...
public class HttpServiceExporter implements HttpRequestHandler {
	...
	private HttpResponseInfo doInvoke(HttpRequestInfo request) throws Exception {
		...
		httpResponseInfo.setRequestId(request.getRequestId());
		...
		try {
			...
			Object object = fastMethod.invoke(service, parameters);

			httpResponseInfo.setResult(object);
		}catch (Exception e) {
			e.printStackTrace();
			httpResponseInfo.setError(e);
		}
