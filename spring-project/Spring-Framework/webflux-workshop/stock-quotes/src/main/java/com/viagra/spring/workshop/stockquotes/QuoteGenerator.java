...
/**
 * To simulate real stock values, we’ll create a generator
 * that emits such values at a specific interval.
 */
@Component
public class QuoteGenerator {
	...
	public Flux<Quote> fetchQuoteStream(Duration period){
		...
		// to dot so, we create a Flux.interval
		return Flux.interval(period)
				...
				.log("com.viagra.spring.workshop.stockquotes");
