...
public class CustomSpringEventPublisher {
    ...
    public void publishEvent(final String message) {
        System.out.printf("Publishing custom event.");
        final CustomSpringEvent customSpringEvent =
    ...
    public void publishGenericEvent(final String message, boolean success) {
        ...
        final GenericSpringEvent<String> genericSpringEvent
                = new GenericStringSpringEvent(message, success);
