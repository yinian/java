 ...
 * @Author: HASEE
 * @Description:
 * @Date: Created in 17:02 2019/4/22
 * @Modified By:
 */
// FIXME: thread id
public class Main {
	...
	public static void main(String[] args) {
		// 线程的优先级信息
		System.out.printf("Minimum Proority: %s\n",Thread.MIN_PRIORITY);
		...
		// 这里用的JDK7中的新语法
		try (FileWriter file = new FileWriter("src/main/java/com/viagra/java/concurrent/java7Concurrencycookbook/chapter01/demo02_getsetthreadinfo/log.txt");
